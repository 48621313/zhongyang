<template>
    <DialogCustom :config="dialogConfig" :visible.sync="dialogConfig.visible" @handleOK="handleOk">
        ...
        <div class="page-custom-box">
            <div class="container">
                <div class="left">
                    <el-tree icon-class="el-icon-arrow-right" :data="data" :props="defaultProps"
                        @node-click="handleNodeClick">
                        <span class="custom-tree-node" slot-scope="{ node, data }">
                            <el-tooltip :disabled="node.level < 2" class="item" effect="dark" :content="data.comments"
                                placement="right">
                                <span class="name"><i class="circle"></i>{{ node.label }}</span>
                            </el-tooltip>
                        </span>
                    </el-tree>
                </div>
                <div class="right">
                    <div class="right-box">
                        ...
                        <div class="bottom">
                            <div class="cm-btn info" @click="close">取消</div>
                            <div class="cm-btn" @click="close">保存</div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            // 弹窗
            dialogConfig: {
                custom_title: true, // 自定义标题
                hide_foot: true,  // 是否隐藏底部
                cover: true,
                loading: true,
                visible: false,
                width: '80%',
