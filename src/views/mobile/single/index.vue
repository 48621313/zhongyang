        ...
        <div class="page-radius">
            <div class="page-common">
                <div class="title-common">
                    <div class="tit-lf tit-before"><span class="tit">投屏预览</span></div>
                    <div class="tit-rt">
                    ...
                    <div class="box-out"
                        ...
                        <div :style="{ width: `${rectangle.width}px`, height: `${rectangle.height}px` }" class="box">
                            <div class="video" style="opacity: 1;">
                                <video id="videoElement" class="main" autoplay muted></video>
                            </div>
                            <div class="canvas">
